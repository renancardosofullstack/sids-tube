export const container = "min-h-screen flex bg-gray-50 dark:bg-slate-900";
...
export const main = "flex-1 p-4 sm:p-6 lg:p-8 w-full bg-gray-50 dark:bg-slate-800 dark:text-slate-100 transition-colors";
export const contentWrapper = "max-w-6xl mx-auto";

export const menuButton = "fixed top-2 left-2 z-40 bg-slate-800 text-white p-1.5 rounded-md shadow-lg hover:bg-slate-700 transition-colors";
