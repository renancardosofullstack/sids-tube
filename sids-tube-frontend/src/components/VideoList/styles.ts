...
export const emptyStateIconWrapper = "mx-auto w-16 h-16 bg-amber-100 dark:bg-amber-900/40 rounded-full flex items-center justify-center mb-4";
...
export const hero = "flex items-center justify-between gap-6 rounded-3xl border border-amber-200 bg-gradient-to-br from-amber-50 via-white to-blue-50 p-6 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900";
export const eyebrow = "mb-2 inline-flex items-center gap-2 rounded-full bg-amber-100 px-3 py-1 text-xs font-bold uppercase tracking-wider text-amber-800 dark:bg-amber-900/40 dark:text-amber-200";
export const title = "text-2xl sm:text-3xl font-bold text-slate-800 dark:text-slate-100";
export const subtitle = "mt-2 max-w-2xl text-sm text-slate-600 dark:text-slate-300";
...
export const searchInput = "w-full pl-12 pr-4 py-3 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500";
